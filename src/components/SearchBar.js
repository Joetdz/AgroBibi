  ...
  return (
    <div>
        <form className='flex flex-row space-x-2'>
            <select className='bg-[#189643] border border-[#189643]  text-white p-1 pr-4 pl-4 rounded-md space-x-2'>
             ...
             <select className='bg-[#189643] border border-[#189643]  text-white p-1 pr-4 pl-4 rounded-md'>
                <option>Prix</option>
            </select>
             <select className='bg-[#189643] border border-[#189643]  text-white p-1 pr-4 pl-4 rounded-md'>
                <option>Type</option>
