    ...
    <Layout>
      <section className=" h-[100vh] ">
        <div className="flex h-[45vh] w-full  flex-col bg-[url('/agrobibi/Legumes.png')] bg-cover bg-center bg-no-repeat">
          <div className="justify-centerbg-black flex h-full w-full  flex-col items-center bg-black bg-opacity-60">
            <span className="mb-10 flex w-full flex-col border-b-2 border-t-2 p-3 pb-8 pt-24 text-center md:w-2/3">
